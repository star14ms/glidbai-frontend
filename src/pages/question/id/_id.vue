...
export default class Page extends Vue {
    ...
    startTextList: string[] = [
      '안녕하세요! <br> 당신의 영어 학습 도우미, 글라이디입니다 😊 <br> 문제 풀이 중 도움이 필요하시면 언제든지 채팅으로 편하게 질문해주세요. 아래 제공된 다양한 옵션 중 하나를 선택하여 사용해보시는 것도 좋은 방법이에요. 기쁜 마음으로 도와드리겠습니다!',
      '1번 문제를 완료하셨군요! <br> 이제 2번 문제를 시작해봅시다. <br><br> 이해가 잘 되지 않거나 추가 설명이 필요하시면 언제든지 알려주세요. 도와드리기 위해 여기 있어요! 😇',
