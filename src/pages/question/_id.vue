...
export default class Page extends Vue {
    ...
    startTextList: string[] = [
      ...
      '2번 문제도 잘 해결하셨어요! 이제 3번 문제로 넘어가봅시다. <br> 만약 어려움이 있거나 더 깊이 이해하고 싶으시면 언제든지 말씀해주세요. 항상 도와드리기 위해 기다리고 있어요! ',
      '3번 문제까지 모두 해결하셨군요! 이제 2문제밖에 남지 않았어요. 끝까지 완주해보아요 😊 <br> 문제를 풀다가 혹시나 헷갈리거나 추가적인 정보가 필요하시면 망설이지 말고 알려주세요!',
      '4번 문제도 성공적으로 마무리하셨네요! 이제 마지막 문제가 남았어요. 화이팅하시고 끝까지 잘 마무리 해봅시다! <br> 만약 도움이 필요하시면 언제든지 알려주세요. 함께 끝까지 힘을 합쳐 최선의 결과를 이끌어냅시다!',
    ]
